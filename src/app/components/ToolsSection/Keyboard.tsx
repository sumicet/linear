...
export function Keyboard({ sx, ...rest }: HTMLChakraProps<'svg'>) {
    return (
        <chakra.svg
            {...rest}
            viewBox='0 0 709 227'
        ...
        >
            <rect width='708.683' height='227' fill='#838383' fillOpacity='0.1' rx='12' />
            <g data-key='pageup'>
                <rect
                    width='38.756'
                    height='38.756'
            ...
            <g data-key='backspace'>
                <rect width='92' height='39' x='565' y='9' fill='#fff' fillOpacity='0.08' rx='4' />
                <path
                    fill='#fff'
            ...
            <g data-key='l'>
                <rect
                    ...
                    rx='4'
                />
                <path fill='#fff' d='M442.09 117.736v-6.486h.785v5.789h3.015v.697h-3.8z' />
                <rect
                    width='38.256'
                    height='38.256'
                    x='424.719'
            ...
            <g data-key='i'>
                <rect
                    ...
                    rx='4'
                />
                <path fill='#fff' d='M399.727 68.803v6.486h-.786v-6.486h.786z' />
                <rect
                    width='38.256'
                    height='38.256'
                    x='379.508'
            ...
            <g data-key='t'>
                <rect
                    ...
                    rx='4'
                />
                <path fill='#fff' d='M268.218 69.5v-.697h4.865v.697h-2.04v5.79h-.785V69.5h-2.04z' />
                <rect
                    width='38.256'
                    height='38.256'
                    x='252.164'
            ...
            <g data-key='arrowright'>
                <rect
                    ...
                    rx='4'
                />
                <path fill='#fff' d='M677.256 202.811v-8.108l6.891 4.054-6.891 4.054z' />
                <rect
                    width='38.256'
                    height='38.256'
                    x='660.945'
            ...
            <g data-key='arrowdown'>
                <rect
                    ...
                    rx='4'
                />
                <path fill='#fff' d='M641.811 195.258l-4.054 6.892-4.054-6.892h8.108z' />
                <rect
                    width='38.256'
                    height='38.256'
                    x='618.5'
            ...
            <g data-key='arrowleft'>
                <rect
                    ...
                    rx='4'
                />
                <path fill='#fff' d='M598.742 202.811l-6.892-4.054 6.892-4.054v8.108z' />
                <rect
                    width='38.256'
                    height='38.256'
                    x='576.055'
            ...
            <g data-key='arrowup'>
                <rect
                    ...
                    rx='4'
                />
                <path fill='#fff' d='M633.189 158.742l4.054-6.892 4.054 6.892h-8.108z' />
                <rect
                    width='38.256'
                    height='38.256'
                    x='618.5'
